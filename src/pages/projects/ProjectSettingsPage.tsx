...
export const ProjectSettingsPage: React.FC = () => {
  ...
  const handleRegenerateKey = async () => {
    if (
      !window.confirm(
        "Are you sure? The old API key will stop working immediately.",
      )
    )
      return;
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">
          Manage configuration and credentials for {project.name}
        </p>
      </div>
      ...
      <Card className="p-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
          This key is required to authenticate requests from your SDK to the
          TraceForge ingestion API.
        </p>
      ...
      <Card className="p-6 border-red-200 dark:border-red-900/30">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Deleting a project is irreversible. All associated analytics data will
